...
$(document).ready(function () {
    //GrindPlayer===============================
    var flashvars = {
        src: "rtmp://localhost:1935/livecam"
    };
    var params = {
    ...
    function identifyFace() {
        ...
        url = 'http://'+document.location.hostname+':8080/video/' + videoName;
...
function playVideo(url, auto) {
    var flashvars = {
        ...
        i: './img/max_logo.png'     //封面图地址
    };
    var params = {bgcolor: '#FFF', allowFullScreen: true, allowScriptAccess: 'always', wmode: 'transparent'};//设置播放器地址、视频容器id、宽高等信息
    CKobject.embedSWF('./ckplayer/ckplayer.swf', 'video1', 'ckplayer_a1', '100%', '100%', flashvars, params)
